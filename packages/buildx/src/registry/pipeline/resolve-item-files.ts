...
import type { PackageRegistryItem, VirtualRegistryFile } from '../types';
...
export async function resolveItemFiles(workspaceRoot: string, item: PackageRegistryItem, virtualFiles: VirtualRegistryFile[]): Promise<ResolvedRegistryFile[]> {
