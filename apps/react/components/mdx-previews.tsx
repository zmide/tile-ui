    ...
    >
      <div className="component-preview__stack">
        <div className="form-group">
          <Label required htmlFor="preview-feedback">Feedback</Label>
  ...
  return (
    ...
    >
      <div className="component-preview__stack">
        ...
        <p className="component-preview__text">Current theme preference: <strong>{theme}</strong></p>
      </div>
    </ComponentPreview>
  )
}
