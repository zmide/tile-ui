  ...
  return (
    <main className="docs-shell">
      <section className="hero">
        ...
        <p className="lede">
          A React-focused documentation surface for Tile UI. Install the package, browse registry items, and
      ...
      <section className="showcase-shell">
        <div className="showcase-header">
          ...
          <p className="showcase-copy">
            The same primitives are available from the package and from the React registry hosted on this site.
          </p>
        </div>
        ...
        <div className="showcase-footer">
          Tile UI React combines a shared SCSS design system with framework-specific ergonomics and registry-driven distribution.
        </div>
      </section>
    </main>
  );
