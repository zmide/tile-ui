...
export const reactComponents: ComponentDoc[] = [
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/button.json',
	...
	},
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/input.json',
	...
	},
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/textarea.json',
	...
	},
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/label.json',
	...
	},
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/card.json',
...
export const vueComponents: ComponentDoc[] = [
	{
		...
		title: 'Button',
		description: 'A multi-variant action component with loading state and size variants.',
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/button.json',
	...
	},
	{
		...
		title: 'Input',
		description: 'A text input with built-in label, helper text, and error state handling.',
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/input.json',
	...
	},
	{
		...
		title: 'Textarea',
		description: 'A multi-line field with the same label and helper affordances as Input.',
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/textarea.json',
	...
	},
	{
		...
		title: 'Label',
		description: 'A lightweight form label with support for required-state styling.',
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/label.json',
	...
	},
	{
		...
		title: 'Card',
		description: 'Composable card primitives for headers, content, descriptions, and actions.',
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/card.json',
...
export const reactHooks: UtilityDoc[] = [
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/use-local-storage.json',
	...
	},
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/use-media-query.json',
	...
	},
	{
		...
		install: 'pnpm dlx shadcn@latest add https://react.tileui.zmorg.cn/r/use-copy-to-clipboard.json',
...
export const vueComposables: UtilityDoc[] = [
	{
		...
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/use-local-storage.json',
	...
	},
	{
		...
		title: 'useMediaQuery',
		description: 'Read responsive state and viewport changes without rewriting browser event plumbing.',
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/use-media-query.json',
		usage: "const isMobile = useMediaQuery('(max-width: 768px)')",
	},
	{
		slug: 'use-copy-to-clipboard',
		...
		install: 'pnpm dlx shadcn@latest add https://vue.tileui.zmorg.cn/r/use-copy-to-clipboard.json',
		usage: 'const { copy, copied } = useCopyToClipboard()',
	},
];
