...
```bash
pnpm dlx shadcn@latest add https://vue.tile-ui.dev/r/styles.json
pnpm dlx shadcn@latest add https://vue.tile-ui.dev/r/core.json
pnpm dlx shadcn@latest add https://vue.tile-ui.dev/r/utils.json
```
