      ...
      >
        <div class="component-preview__stack">
          ...
          <TInput
            ...
            helperText="Use this for immutable values or generated fields."
            modelValue="tile-ui"
          />
          <TInput
    ...
    return () => (
      ...
      >
        <div class="component-preview__stack">
          ...
          <TTextarea
            label="Validation example"
            error="Please provide at least 20 characters before submitting."
          ...
          {{
            default: () => [
              ...
              <TCardFooter>
                {{
                  default: () => [
                    <TButton variant="outline">{{ default: () => 'Preview' }}</TButton>,
                    <TButton>{{ default: () => 'Install' }}</TButton>,
                  ],
                }}
              </TCardFooter>,
            ],
  ...
  setup() {
    ...
    return () => (
      ...
      >
        <div class="component-preview__stack">
          <div class="button-group">
            <button class="component-preview__action" onClick={() => { compact.value = !compact.value; }}>
              Toggle compact mode
            </button>
          </div>
          <div class="card-link">
  ...
  setup() {
    ...
    return () => (
      ...
      >
        <div class="component-preview__stack">
          <div class="button-group">
            <button class="component-preview__action" onClick={() => { theme.value = 'light'; }}>Light</button>
            <button class="component-preview__action" onClick={() => { theme.value = 'dark'; }}>Dark</button>
          </div>
          <p class="component-preview__text">Current theme preference: <strong>{theme.value}</strong></p>
        </div>
      </VueDocContentPreview>
    );
  },
              ...
              <TCardFooter>
                {{
                  default: () => [
                    ...
                    <TButton>{{ default: () => 'Submit' }}</TButton>,
                  ],
                }}
              </TCardFooter>,
            ],
            ...
            default: () => [
              ...
              <TCardFooter>
                {{
                  default: () => [
                    <TButton variant="outline">{{ default: () => 'Cancel' }}</TButton>,
                    <TButton>{{ default: () => 'Save changes' }}</TButton>,
                  ],
                }}
              </TCardFooter>,
            ],
